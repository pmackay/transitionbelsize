...
<?php print $picture ?>
  ...
  <?php endif; ?>
     ...
     <?php if (!$page): ?>
    <div class="node-picture"><?php print $image ?></div>
    <h2><a href="<?php print $node_url ?>" title="<?php print $title ?>"><?php print $title ?></a></h2>
  <?php else: ?>
    <h2 class="title"><?php print $title; ?></h2>
  <?php endif; ?>
      
    <div>When: <?php print $event_date; ?></div>
    ...
    <?php else: ?>
      <div>Location: <?php $node = node_load(315); echo $node->title; ?></div>
    <?php endif; ?>
    ...
    <div class="meta">
      <?php if ($display_submitted): ?>
        <span class="submitted">
          Submitted by <?php print $submitted; ?>
        </span>
      <?php endif; ?>
